 ...
 * (Escape, focus trap, focus restore) comes from {@link ModalShell}.
 *
...
export function MoveToFolderDialog({
  ...
  return (
    <ModalShell
      ...
      panelClassName="flex max-h-[70vh] w-full max-w-[360px] flex-col rounded-xl border border-border shadow-[var(--shadow-float)]"
    >
