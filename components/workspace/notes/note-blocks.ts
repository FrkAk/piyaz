 ...
 * semantics (CommonMark fences, leftmost-match-wins inline alternation)
 * so the renderer never chips a ref the extractor did not link. No React,
 ...
 * runs, `- ` list runs, CommonMark fenced code, and paragraphs. Fenced
 ...
 * inline code spans, case-insensitive. Leftmost-match-wins means a code
