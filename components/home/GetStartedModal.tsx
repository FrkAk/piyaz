 ...
 * clay for starting from nothing, sage for growing an existing repo. Each
 * prompt ends in the pulsing terminal cursor from the MyTasksEmpty line,
 * tinted to its card's hue.
 */
