/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env=production --env-interface=CloudflareEnv cloudflare-env.d.ts` (hash: 41b826dfc45f411152e99ae3fd073876)
// Runtime types generated with workerd@1.20260617.1 2026-05-16 nodejs_compat
interface __BaseEnv_CloudflareEnv {
	...
	EMAIL_FROM: "noreply@piyaz.ai";
	EMAIL_FROM_NOREPLY: "noreply@piyaz.ai";
	EMAIL_FROM_SUPPORT: "hello@piyaz.ai";
	EMAIL_FROM_INFO: "noreply@piyaz.ai";
	EMAIL_REPLY_TO: "hello@piyaz.ai";
	REQUIRE_EMAIL_VERIFICATION: "true";
	APP_NAME: "Piyaz";
	BRAND_LOGO_URL: "https://app.piyaz.ai/piyaz-mark.png";
	BRAND_COLOR: "#976b68";
	BRAND_FOOTER_LINKS: "[{\"label\":\"Privacy\",\"url\":\"https://app.piyaz.ai/privacy\"},{\"label\":\"Terms\",\"url\":\"https://app.piyaz.ai/terms\"}]";
	BETTER_AUTH_SECRET: string;
	BROKER_DO_SECRET: string;
	DATABASE_URL: string;
	DATABASE_SERVICE_ROLE_URL: string;
	DATABASE_AUTH_URL: string;
	PIYAZ_BROKER: DurableObjectNamespace<import("./worker-cf").PiyazBroker>;
...
declare namespace Cloudflare {
	interface GlobalProps {
		...
		durableNamespaces: "PiyazBroker" | "DOQueueHandler";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "DEPLOY_TARGET" | "BETTER_AUTH_URL" | "EMAIL_FROM" | "EMAIL_FROM_NOREPLY" | "EMAIL_FROM_SUPPORT" | "EMAIL_FROM_INFO" | "EMAIL_REPLY_TO" | "REQUIRE_EMAIL_VERIFICATION" | "APP_NAME" | "BRAND_LOGO_URL" | "BRAND_COLOR" | "BRAND_FOOTER_LINKS" | "BETTER_AUTH_SECRET" | "BROKER_DO_SECRET" | "DATABASE_URL" | "DATABASE_SERVICE_ROLE_URL" | "DATABASE_AUTH_URL">> {}
}
