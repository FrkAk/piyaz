/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env=production --env-interface=CloudflareEnv cloudflare-env.d.ts` (hash: 5996cab7448571de3b6b1fdc3ba2bec1)
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "DEPLOY_TARGET" | "EMAIL_FROM" | "EMAIL_FROM_NOREPLY" | "EMAIL_FROM_SUPPORT" | "EMAIL_REPLY_TO" | "APP_NAME" | "BRAND_LOGO_URL" | "BRAND_COLOR" | "BRAND_FOOTER_LINKS" | "BETTER_AUTH_SECRET" | "BETTER_AUTH_URL" | "DATABASE_URL" | "DATABASE_SERVICE_ROLE_URL" | "DATABASE_AUTH_URL">> {}
}
