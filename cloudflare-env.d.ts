/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env=production --env-interface=CloudflareEnv cloudflare-env.d.ts` (hash: d504afa98f41b41ebe386a00b08deee2)
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "DEPLOY_TARGET" | "BETTER_AUTH_URL" | "EMAIL_FROM" | "EMAIL_FROM_SUPPORT" | "EMAIL_REPLY_TO" | "APP_NAME" | "BRAND_LOGO_URL" | "BRAND_COLOR" | "BRAND_FOOTER_LINKS" | "BETTER_AUTH_SECRET" | "BROKER_DO_SECRET" | "DATABASE_URL" | "DATABASE_SERVICE_ROLE_URL" | "DATABASE_AUTH_URL">> {}
}
