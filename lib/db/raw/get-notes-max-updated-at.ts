 ...
 * tree-rendered field revalidates. The count is part of the validator
 * because a soft delete removes a row without raising any surviving
 * clock — MAX alone would leave the tree ETag stale after a delete.
 * Scanned via the `project_id` prefix of the partial
