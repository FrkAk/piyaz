  ...
  server.registerTool(
    "mymir_task",
    {
      ...
      inputSchema: z.object({
        ...
        priority: z.enum(["urgent", "core", "normal", "backlog"]).optional()
          .describe("Priority of the task. urgent: cannot ship without; core: central to the release; normal: routine; backlog: deprioritized."),
