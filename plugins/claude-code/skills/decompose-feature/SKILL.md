...
description: >
  Explicit doorway to the Piyaz decompose-feature subagent. Use only when the user
  types /piyaz:decompose-feature directly. For natural-language requests to add a
  new feature or capability cluster to an active project, the /piyaz skill or the
