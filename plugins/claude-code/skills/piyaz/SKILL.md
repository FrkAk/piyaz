...
| `search` | heavy | a full noteRef (e.g. `TRV-N3`, case-insensitive) resolves that note directly; otherwise ranked full text in one project: team notes plus your own private notes, regardless of feed mode. Chain a hit into `read heading='...'`. |
